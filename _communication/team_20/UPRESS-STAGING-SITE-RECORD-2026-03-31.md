...
## 1. סטייג'ינג פעיל (= **סביבת פיתוח** הפרויקט)

| שדה | ערך |
|-----|-----|
| **סיווג** | **סביבת פיתוח / סטייג'ינג** — אין go-live על כתובת זו; בנייה ובדיקות בלבד (מוסכם ארגונית). |
...
| **צ׳ק־ליסט ממשק (פאנל + wp-admin)** | [`M2-RUNBOOK-ENV-2026-03-31.md`](./M2-RUNBOOK-ENV-2026-03-31.md) **§13** (כולל **§13.0** מטמון / SMTP) |
| **מטמון סטייג'ינג (2026-03-29)** | **Varnish** — לא (נדחה לפרודקשן / SSL); חלופות פאנל — מינימום; אופטימיזציה אחרי אוויר. |
