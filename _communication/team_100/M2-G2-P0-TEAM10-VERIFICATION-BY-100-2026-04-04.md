...
בדוח P0-DONE מסומן גיבוי ☑ (אישור מחזיק). אם בפועל לא בוצע גיבוי אוטומטי מהסביבה שבה רצה הסקריפט — **ליישר קו עם נוהל צוות 20** ולתעד; אין סתירה בין «אישור מחזיק» לבין המלצת אבטחה על סיבוב סיסמאות אם `staging.credentials.md` נחשף.
