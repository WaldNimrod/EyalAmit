...
def _status_for_eyal_html(model) -> str:
    ...
    return (
        ...
        "הבדיקה, עמוד אחד עדיין פתוח אצלנו, ובשני נושאים גילינו שמה שביקשת כבר "
        ...
        "</strong> — עדיין לא תוקן, ואנחנו על זה. השדה «נושא הפנייה» שביקשת להסיר "
        "עדיין מופיע, וגם שני כפתורי הוואטסאפ שציינת עדיין שם. אין צורך שתעיר על "
        "זה שוב.</li>\n"
        "</ul>\n"
