...
def main() -> None:
    ...
    print("  2. 301 rules: the LIVE mechanism is the generated PHP mu-plugin")
    print("     site/wp-content/mu-plugins/ea-w209-legacy-301-redirects.php")
    print("     (SSoT: hub/data/decisions/redirects-301-eyal-final-2026-05-27.json")
    print("     via scripts/gen_htaccess_301_from_decisions.py). .htaccess is INERT on nginx.")
    print("     The old blog-301-rules.htaccess/.json exports were QUARANTINED (wrong page")
    print("     targets) -> _COMMUNICATION/team_100/301-quarantine-stale-W2-06-exports/.")
    print("     OPEN: the /Blog/->/blog/ + 54 per-slug blog-post redirects are NOT yet in the")
    print("     mu-plugin SSoT — fold them in before cutover (see 301-MAP-RECONCILIATION doc).")
