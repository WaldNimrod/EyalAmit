...
$faq_data = array(
	...
	array(
		...
		'a'        => "<p>לא מומלץ.</p><p><a href=\"/blog/pregnancy-didgeridoo\">קראו עוד על דיג'רידו והריון</a></p>",
	),
	array(
		'category' => 'lessons',
		'q'        => 'יש לי בעיה בריאותית',
		'a'        => "<p>שיעורים אינם טיפוליים.</p><p>פנו למסלול של <a href=\"/didgeridoo-treatment\">טיפול בדיג'רידו</a></p>",
	),
	array(
		'category' => 'lessons',
	...
	array(
		...
		'a'        => "<p>בסאונד הילינג מדובר במפגש פאסיבי שבו מקשיבים לצליל ונמצאים בתוך המרחב שנוצר.</p><p>לעומת זאת, בטיפול בדיג'רידו העבודה היא אקטיבית, ומבוססת על תהליך אישי עם הנשימה.</p><p>הדיג'רידו משמש בשני המקרים ככלי עבודה, אך המטרה שונה: בסאונד הילינג הדגש הוא על שהייה והקשבה, ואילו בטיפול העבודה היא על פיתוח שליטה בנשימה והשפעה על האופן שבו היא מתנהלת ביומיום.</p><p>👉 <a href=\"/didgeridoo-treatment\">למידע נוסף על טיפול בדיג'רידו</a></p>",
	),
	array(
		'category' => 'sound-healing',
	...
	array(
		...
		'a'        => "<p>למרות השם הדומה, מדובר בשתי גישות שונות לחלוטין.</p><p>נשימה מעגלית בדיג'רידו היא טכניקה פיזית שמאפשרת להפיק צליל רציף על ידי שילוב בו זמני בין נשיפה מהפה ושאיפה מהאף.</p><p>לעומת זאת, בריברסינג מדובר בתהליך נשימתי רציף שמטרתו לרוב לעורר חוויה רגשית או תודעתית.</p><p>למידע נוסף: <a href=\"https://www.eyalamit.co.il/Blog/%d7%a8%d7%99%d7%91%d7%a8%d7%a1%d7%99%d7%a0%d7%92-%d7%a0%d7%a9%d7%99%d7%9e%d7%94-%d7%9e%d7%a2%d7%92%d7%9c%d7%99%d7%aa-%d7%95%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95/\">ריברסינג, נשימה מעגלית ודיג'רידו</a></p>",
	),
	array(
		'category' => 'method',
	...
	array(
		'category' => 'general',
		'q'        => 'כמה זה עולה?',
		'a'        => "<p>המחירים משתנים בהתאם לסוג המפגש - <a href=\"/didgeridoo-treatment\">טיפול בדיג'רידו,</a> <a href=\"/lessons\">שיעורי נגינה בדיג'רידו</a> או <a href=\"/sound-healing\">סאונד הילינג בדיג'רידו.</a></p><p>הדרך הפשוטה היא לפנות ולקבל הסבר מדויק לפי הצורך.</p>",
	),
	array(
		'category' => 'general',
	...
	array(
		...
		'a'        => "<p>כן.</p><p>יש אפשרות לרכוש כלים שנבנים בעבודת יד על ידי אייל עמית, בהתאמה אישית.</p><p>למידע נוסף: <a href=\"https://www.eyalamit.co.il/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%94%d7%9e%d7%a8%d7%9b%d7%96-%d7%9c%d7%98%d7%99%d7%a4%d7%95%d7%9c-%d7%91%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%a1%d7%98%d7%95%d7%93%d7%99/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%9c%d7%9e%d7%9b%d7%99%d7%a8%d7%94-%d7%9b%d7%9c%d7%99%d7%9d-%d7%91%d7%a2%d7%91%d7%95%d7%93%d7%aa-%d7%99%d7%93/\">דיג'רידו למכירה - כלים בעבודת יד</a></p>",
	),
	array(
		'category' => 'general',
		'q'        => "האם יש גם אביזרים נלווים?",
		'a'        => "<p>כן.</p><p>ניתן למצוא גם אביזרים משלימים לנגינה ולתחזוקה:</p><ul><li><a href=\"https://www.eyalamit.co.il/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%94%d7%9e%d7%a8%d7%9b%d7%96-%d7%9c%d7%98%d7%99%d7%a4%d7%95%d7%9c-%d7%91%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%a1%d7%98%d7%95%d7%93%d7%99/%d7%aa%d7%99%d7%a7%d7%99%d7%9d-%d7%9c%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95/\">תיקי נשיאה לדיג'רידו</a></li><li><a href=\"https://www.eyalamit.co.il/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%94%d7%9e%d7%a8%d7%9b%d7%96-%d7%9c%d7%98%d7%99%d7%a4%d7%95%d7%9c-%d7%91%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%a1%d7%98%d7%95%d7%93%d7%99/%d7%a1%d7%98%d7%a0%d7%93-%d7%a8%d7%a6%d7%a4%d7%aa%d7%99-%d7%9c%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%9c%d7%a0%d7%92%d7%99%d7%a0%d7%94-%d7%91%d7%99%d7%a9%d7%99%d7%91%d7%94-%d7%a0%d7%9e%d7%95/\">סטנד לנגינה בישיבה נמוכה</a></li><li><a href=\"https://www.eyalamit.co.il/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%94%d7%9e%d7%a8%d7%9b%d7%96-%d7%9c%d7%98%d7%99%d7%a4%d7%95%d7%9c-%d7%91%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%a1%d7%98%d7%95%d7%93%d7%99/%d7%a1%d7%98%d7%a0%d7%93%d7%99%d7%9d-%d7%9c%d7%90%d7%97%d7%a1%d7%95%d7%9f-%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%91%d7%aa%d7%9c%d7%99%d7%99%d7%94-%d7%90%d7%95-%d7%91%d7%a2%d7%9e%d7%99%d7%93/\">סטנדים לאחסון דיג'רידו</a></li></ul>",
	),
	array(
		'category' => 'general',
		'q'        => "האם ניתן לתקן דיג'רידו?",
		'a'        => "<p>כן.</p><p>יש אפשרות לתיקון ושיקום כלי דיג'רידו.</p><p>למידע נוסף: <a href=\"https://www.eyalamit.co.il/%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%94%d7%9e%d7%a8%d7%9b%d7%96-%d7%9c%d7%98%d7%99%d7%a4%d7%95%d7%9c-%d7%91%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95-%d7%a1%d7%98%d7%95%d7%93%d7%99/%d7%aa%d7%99%d7%a7%d7%95%d7%9f-%d7%93%d7%99%d7%92%d7%a8%d7%99%d7%93%d7%95/\">תיקון דיג'רידו</a></p>",
	),
	array(
		'category' => 'general',
		'q'        => 'האם יש סדנאות קבוצתיות?',
		'a'        => "<p>לעיתים מתקיימות סדנאות חד פעמיות, אך עיקר העבודה נעשית באופן אישי במסגרת <a href=\"/didgeridoo-treatment\">טיפול בדיג'רידו</a> או <a href=\"/lessons\">שיעורי נגינה בדיג'רידו</a>.</p>",
	),
	...
	array(
		...
		'a'        => "<p>מוקש היה מאסטר לדיג'רידו, יוגי מזרם הבהקטי שחי עם משפחתו ברישיקש הודו, התמחה בבניית כלי דיג'רידו והקדיש את חייו להפצת הדיג'רידו ומלאכת בנייתו בעולם. פעילותו החלה באמצע שנות השבעים והסתיימה עם פטירתו בשנת 2020.</p><p>אייל עמית למד אצלו לאורך שנים והיה מתלמידיו הקרובים מאז שנת 2000. הקשר הזה מהווה חלק משמעותי מהבסיס שעליו נבנתה <a href=\"/method\">השיטה - cbDIDG</a></p><p>למידע נוסף: <a href=\"/mokesh\">מוקש</a></p>",
	),
	array(
		'category' => 'general',
		'q'        => 'האם יש קורס להכשרת מטפלים?',
		'a'        => "<p>כן.</p><p>קיים קורס הכשרה למטפלים בשיטת cbDIDG של אייל עמית, המיועד למי שמעוניין להעמיק בעבודה עם נשימה ולהפוך אותה לכלי מקצועי בעבודה עם אנשים.</p><p>למידע נוסף: <a href=\"/cbDidg-therapy-training\">קורס הכשרה למטפלים בשיטת cbDIDG</a></p>",
	),
	...
	array(
		...
		'a'        => "<p>כן.</p><p>אייל עמית כתב והוציא לאור 3 ספרים במסגרת <a href=\"/muse\">מוזה הוצאה לאור</a></p>",
	),
	array(
		'category' => 'general',
