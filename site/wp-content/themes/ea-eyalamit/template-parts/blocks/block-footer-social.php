...
$ea_cfoot_nav = array(
	...
	array( 'href' => home_url( '/shop/' ),                 'label' => 'כלים ואביזרים' ),
	array( 'href' => home_url( '/books/' ),               'label' => 'ספרים – מוזה הוצאה לאור' ),
      ...
      <div class="ea-footer__inner">
        <div class="ea-cfoot">
          ...
          <div class="ea-cfoot__brandcol">
            ...
            <p class="ea-cfoot__tag">המרכז לטיפול בנשימה באמצעות דיג׳רידו · cbDIDG</p>
