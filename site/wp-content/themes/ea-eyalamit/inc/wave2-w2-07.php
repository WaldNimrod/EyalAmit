...
function ea_wave2_editorial_route_content( $route ) {
	...
	if ( 'about' === $route ) {
		return array(
			'hero'     => array(
				'kicker'    => 'אודות · המרכז לטיפול בדיג׳רידו',
				'title'     => 'אייל עמית',
				'lead'      => 'עוסק בעבודה עם דיג׳רידו מאז 1999, ומהוותיקים בארץ בתחום. מורה, מטפל בנשימה, סופר — ומייסד המרכז לטיפול בדיג׳רידו בפרדס חנה.',
				'image'     => $portrait,
			...
			'intro'    => array(
				'heading'    => 'משהו בנשימה התחיל את הכל',
				'aria_label' => 'משהו בנשימה התחיל את הכל',
				'body'       => array(
					'הדרך של אייל עם הדיג׳רידו לא התחילה מתוך מוזיקה, אלא מתוך מסע אישי של חקירה ורצון להתמודד עם קשיים בריאותיים — אסטמה ואלרגיות קשות שליוו אותו שנים.',
					'מה שהתחיל כסקרנות הפך לתהליך ריפוי עמוק, ובהמשך לשיטה שלמה שמלווה היום מאות אנשים.',
				),
			),
			'sections' => array(
				array(
					'label'   => 'המרכז',
					'heading' => 'המרכז לטיפול בדיג׳רידו',
					'lead'    => true,
					'body'    => array(
						'סטודיו נשימה מעגלית בפרדס חנה — מקום שהוקם מתוך רצון להנגיש וללמד את העבודה עם הדיג׳רידו ככלי להשפעה תרפויטית על הגוף, הנשימה והתודעה.',
						'לאורך השנים ליווה אייל מאות אנשים בתהליכים אישיים, ופיתח את שיטת cbDIDG לטיפול באמצעות דיג׳רידו — מתוך שילוב של ניסיון מעשי, חקירה מתמשכת, וחשיבה שיטתית שהביא איתו מהרקע שלו כמהנדס אלקטרוניקה.',
					),
				),
			),
			'timeline' => array(
				'label'   => 'ציר זמן',
				'heading' => 'כמה תחנות בדרך',
				'items'   => array(
					array( 'label' => '1999—2000', 'title' => 'המפגש עם הדיג׳רידו ועם מוקש', 'text' => 'תחילת הקשר המתמשך עם המאסטר ההודי מוקש דהימן — שיהפוך לציר המרכזי של הדרך התרפויטית.' ),
					array( 'label' => '2001', 'title' => 'צבע בכחול וזרוק לים', 'text' => 'הספר הראשון — 38 סיפורים מהטיול הגדול בדרום אמריקה. כיום במהדורה עשירית.' ),
					array( 'label' => '2004', 'title' => 'כושי בלאנטיס', 'text' => 'רומן פנטזיה על התעוררות, בחירה ויציאה מהחיים הנוחים מדי.' ),
					array( 'label' => '2017', 'title' => 'וכתבת', 'text' => 'קובץ של 46 סיפורים אמיתיים בסגנון ״ספוקן סטוריז״, עם קודי QR שמרחיבים כל סיפור.' ),
					array( 'label' => 'מאז', 'title' => 'שיטת cbDIDG', 'text' => 'מתודולוגיה סדורה לעבודה עם הנשימה, שמלווה מאות מטופלים מכל הארץ.' ),
					array( 'label' => 'היום', 'title' => 'המרכז בפרדס חנה', 'text' => 'סטודיו שתוכנן אקוסטית, טבול בירוק — מפגשים אישיים, סדנאות, וכתיבה חדשה.' ),
				),
			),
			'memorial' => ea_wave2_editorial_memorial(),
			'studio'   => array(
				'label'         => 'המרחב',
				'heading'       => 'הסטודיו בפרדס חנה',
				'body'          => array(
					'הסטודיו ממוקם בפרדס חנה, בתוך מרחב ירוק ושקט עם חצר פתוחה, עצי פרי ושבילי עץ — מקום שנבנה ותוכנן מתוך הבנה אקוסטית של צליל ותדר.',
				),
				'gallery_label' => 'הסטודיו בפרדס חנה',
				'gallery_note'  => 'תמונות סטודיו נוספות יוטמעו לאחר מסירת הנכסים מאייל.',
				'cells'         => array(
					array( 'image' => $studio, 'alt' => 'הסטודיו בפרדס חנה' ),
					array( 'text' => 'מרחב הטיפול' ),
					array( 'text' => 'עצי פרי' ),
					array( 'text' => 'שבילי עץ' ),
				),
			),
