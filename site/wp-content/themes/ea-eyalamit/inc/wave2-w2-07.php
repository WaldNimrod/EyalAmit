	...
	if ( 'about' === $route ) {
		...
		return array(
			...
			'sections' => array(
				...
				// SECTION 07
				array(
					'heading' => 'המרכז לטיפול בדיג׳רידו, פרדס חנה',
					'body'    => array(
						...
						'מתוך החזון הזה הקמתי את המרכז לטיפול בדיג׳רידו בפרדס חנה, במטרה לקדם, להפיץ וללמד את איכויותיו התרפויטיות של הדיג׳רידו בתחומי הגוף, הנפש והתודעה.',
