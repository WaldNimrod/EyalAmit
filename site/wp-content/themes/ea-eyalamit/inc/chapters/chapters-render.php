...
function ea_chapters_phero_overlay() {
	...
	if ( in_array( ea_chapters_type(), array( 'treatment', 'method' ), true ) ) {
...
function ea_chapters_page_sections() {
	...
	foreach ( $secs as $n => $sec ) {
		...
		/* S006 R1-02/R1-03 · /treatment/ and /method/ render seeded defaults only (see phero overlay). */
		if ( in_array( $type, array( 'treatment', 'method' ), true ) ) {
