...
function ea_chapters_route_map() {
	return (array) apply_filters( 'ea_chapters_route_map', array(
		...
		'thank-you'     => array( 'template' => 'tpl-chapters-page',   'type' => 'thank-you' ),
		...
		'courses-external'  => array( 'template' => 'tpl-chapters-page', 'type' => 'courses-external' ),
	) );
}
...
function ea_chapters_phero_overlay() {
	...
	if ( in_array( ea_chapters_type(), array( 'treatment', 'method', 'lessons', 'sound-healing', 'shop', 'muzza', 'about', 'mokesh', 'didgeridoos', 'bags', 'stands-storage', 'stand-floor', 'repair', 'kushi-blantis', 'tsva-bekahol', 'vekatavta', 'faq', 'snoring-sleep-apnea', 'en', 'courses-external' ), true ) ) {
...
function ea_chapters_page_sections() {
	...
	foreach ( $secs as $n => $sec ) {
		...
		if ( in_array( $type, array( 'treatment', 'method', 'lessons', 'sound-healing', 'shop', 'muzza', 'about', 'mokesh', 'didgeridoos', 'bags', 'stands-storage', 'stand-floor', 'repair', 'kushi-blantis', 'tsva-bekahol', 'vekatavta', 'faq', 'snoring-sleep-apnea', 'en', 'courses-external' ), true ) ) {
...
function ea_chapters_content_img_alt_map() {
	...
	$map = array(
		...
		'017b3d09ded24199081a17efce151f5a23951007bbb36cc3920e29fb0d8665bf' => 'תמונה של מוקש עם ענת אשתי והילדים מ 2018',
		'01f2bdb3599205528d90c55dee262ed36ae625da1312f4bfcf09feeb9ba6e521' => 'קערת דובדבנים טריים לצד עותק הספר וכתבת',
		'030d9b417b17194db01a415a31d23c84c06583b7e76bc13e7cd018c9a0042a1b' => "זו ג'מה הספרדייה, תלמידה ותיקה של מוקש",
		...
		'16f520358c05a91f42cafed7af7abfb084adfd1e20a2f708562bbbeaa924e5a9' => 'זה סטנד רצפתי',
		...
		'1a1e1893afde01075bc9f2e2d4f8f8735087a2b6aff8239a50d51c185ee9e845' => 'מוקש משקיף על הגנגס סמוך לקוטלי',
		...
		'21efc3f76105a27c601abc4c8ec2b5cca8bf48e0e151bdaefd12baa0ac6cf3ef' => 'אני , גיא אח שלי ומוקש',
		...
		'54960f93f8400b020a4d4e7bd8c8962f42367987336eea2a05f0999b0411759e' => 'אניטה אשתו של מוקש',
		...
		'5708cc2795ca6a7234861c4b1866e8ddd666c3d5bd632222d21d224fca6b4b24' => 'זה השלד של הסטודיו החדש בקוטלי. ככה עמד 6 שנים עד שאני הגעתי',
		...
		'66eb3212aeee7dfb652124567009aaa26347ec2925540d387c2bf278453a42ff' => 'שנת 2003 - מוקש אוחז בספר הראשון שלי שראה אור ב 2001',
		...
		'735966f8d3adf230653cff5fde78d1bcd2b72b103a9e66562a9c072a74502e46' => 'בחצר אצל מוקש',
		...
		'847b20e76ae6fc8c8916a6effbdda556e5d2ca6747b82dc31df3abe0752e8761' => 'סטנד לתלייה על הקיר',
		'8692139c557c7c8643908789bd0c89f37f80a8dbb75f62ed2dc214ddf8463498' => 'הביקתה בקוטלי',
		...
		'8d5f8916d56ae25194d0c2d61c1dc7cb8dfcb0711baeea0af15b8123c4fb50d6' => 'אני ומוקש',
		...
		'943f2de334af65b7a90ba18ec824733425d777e64826a544d12d6fe90145fc9e' => "זה הדיג' שנגנב. צילום אחרון שלו בבית המלאכה אצל מוקש 2003. אחרי האירוע כל מסלול חיי הוסת והתחלתי לעסוק בדיג'רידו",
		...
		'c148197046abeac983257a60996cf7baa859239aaecb47907ff8021b24163690' => 'סטנד רצפתי',
		...
		'cb8515ed3a1e172a96d88d4656981a6edfd9c2cea89ee25b2711962a3f5fa4da' => 'סטנד רצפתי',
		...
		'cf8ff0b99d3b0a2f2ce41075e0f7444f7aa6d91d699ddc1910a9e66e19a15477' => 'סטנד רצפתי',
		...
		'f864fc9272a1ade9cbfe16c33abeec93764d742ebdfc4eb0d11a4a278cf8fae7' => 'הבנים של מוקש ואני',
