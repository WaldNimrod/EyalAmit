<?php
/**
 * Chapters /didgeridoos/ — Eyal's copy from Drive, one section per block.
 *
 * S006 R1-12 · מקור: content 13.8.26/כלים למכירה/buy didgeridoo.md
 *
 * @package ea_eyalamit
 */
...
return array(
	...
	'phero' => array(
		/* S006 · מקור: content 13.8.26/כלים למכירה/buy didgeridoo.md · SECTION 01 */
		'title'     => "כלי דיג'רידו למכירה -<br>כלים בעבודת יד",
		/* S006 · מקור: content 13.8.26/כלים למכירה/buy didgeridoo.md · SECTION 01 */
	...
	'sections' => array(
		...
		array(
			...
			'args' => array(
				...
				/* S006 · מקור: content 13.8.26/כלים למכירה/buy didgeridoo.md · SECTION 07 */
				'body'  => '<p>מעבר לכלי עצמו, יש גם אביזרים שמשפרים את חוויית השימוש ושומרים על הכלי לאורך זמן.</p><ul><li><strong><a class="tlink" href="/bags/">תיקים לדיג\'רידו</a></strong> לנשיאה נוחה והגנה על הכלי</li><li><strong><a class="tlink" href="/stands-storage/">סטנדים לאחסון דיג\'רידו</a></strong> שומרים על הכלי יציב ומוגן מנפילות (חשוב במיוחד כי דיג\'רידו הוא כלי שביר)</li><li><strong><a class="tlink" href="/repair">תיקון וחידוש דיג\'רידו</a></strong> חידוש, איטום וטיפול בכלים קיימים להארכת חיי הכלי</li></ul><p>האביזרים נבחרים מתוך ניסיון בעבודה יומיומית עם הכלים, ומתוך הבנה של מה באמת נדרש בשטח.</p>',
			),
		),
		...
		/* S006 גל 6 · קרוסלת חצים (גל 5) + כפתור לכל העדויות. בלי תמונות פרופיל — אין קבצים. */
		array(
			'part' => 'testimonials',
			'args' => array(
				...
				'items' => array(
					array(
						...
						'text' => 'כמו רבים אחרים גם אני חשבתי שאני באה "ללמוד דיג\'רידו".. לא היה לי שמץ של מושג איזה מסע עוצמתי אני הולכת לעבור... מעבר לסידור הנשימה שמסדר את הנשמה, קיבלתי גם השקטה של הראש העמוס, ליטוף וחיבוק של הלב.',
					),
					array(
						'name' => 'רותי שליט',
		...
		array(
			'part' => 'cta',
			'args' => array(
				'cta_label' => 'לכל העדויות וההמלצות',
		...
		array(
			'part' => 'prose',
			'args' => array(
				'body' => '<p>מי שמתחיל לעבוד עם הכלי, מבין מהר מאוד שזה לא רק עניין של נגינה.</p><p>אפשר לקרוא עוד על <a class="tlink" href="/treatment">טיפול בדיג\'רידו</a></p>',
			),
		),
