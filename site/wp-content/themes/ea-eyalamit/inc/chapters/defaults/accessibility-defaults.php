	...
	'sections' => array(
		...
		array(
			...
			'args' => array(
				...
				'body'  => '<p>כל הפריטים הבאים נבדקו ונמדדו על האתר עצמו בספטמבר 2026, בשנים־עשר עמודים מרכזיים:</p><ul><li><strong>מבנה כותרות תקין.</strong> כותרת ראשית אחת בכל עמוד, ללא דילוג בין רמות הכותרות, כך שניתן לסרוק את העמוד לפי כותרות.</li><li><strong>טקסט חלופי לתמונות התוכן.</strong> כל תמונה נושאת תיאור, למעט תמונות קישוט המסומנות ככאלה ולמעט מספר תמונות שטרם זוהו — ראו «מגבלות ידועות» למטה.</li><li><strong>קישור «דלג לתוכן»</strong> בראש כל עמוד, המעביר את המיקוד לאזור התוכן הראשי.</li><li><strong>ניווט מלא במקלדת</strong>, לרבות התפריט במסכים צרים, עם סימון מיקוד נראה לעין על כל פקד.</li><li><strong>הגדלת טקסט</strong> עד פי שניים ללא חיתוך תוכן וללא גלילה אופקית.</li><li><strong>סימון אזורי תוכן</strong> — אזור תוכן ראשי יחיד, אזורי ניווט מסומנים בשם, ומזהים ייחודיים ללא כפילויות.</li><li><strong>ניגודיות צבעים</strong> מותאמת לטקסט ולרכיבי הממשק, לרבות מצב המיקוד במקלדת.</li></ul>',
			),
		),
		array(
			'part' => 'prose',
			'args' => array(
				'chap'  => 'מגבלות',
				'title' => 'מגבלות ידועות',
				'body'  => '<p>אנו מעדיפים לפרט את המגבלות שאנו מכירים, ולא להסתפק בנוסח כללי:</p><ul><li><strong>לא בוצעה בדיקה בקורא מסך.</strong> האתר נבנה עם סימון מתאים לקוראי מסך ונבדק בכלים אוטומטיים וידניים, אך טרם נבדק בפועל מול תוכנת קורא מסך.</li><li><strong>מספר תמונות בגלריות הספרים ממתינות לזיהוי</strong> ולכן טרם ניתן להן תיאור. העדפנו להשאירן ללא תיאור על פני לנחש את תוכנן.</li><li><strong>רכיב ממשק אחד</strong> — תגית נושא במצב מסומן — עדיין אינו עומד ביחס הניגודיות הנדרש, ותיקונו מצריך שינוי בצבע מותג.</li><li><strong>תכני צד שלישי</strong>, ובהם הטמעות וידאו, אינם בשליטתנו המלאה.</li><li><strong>כלי בדיקה אוטומטיים אינם מעידים על עמידה בתקן.</strong> למדנו זאת באתר הזה: סורק תקני דיווח «אפס תקלות» על עמודים שבהם 162 תמונות תוכן היו חסרות תיאור לחלוטין. לכן כל הבדיקות שלעיל נעשו גם ידנית.</li></ul><p>אנו ממשיכים לפעול לשיפור הנגישות באופן שוטף.</p>',
			),
		),
		array(
			'part' => 'prose',
