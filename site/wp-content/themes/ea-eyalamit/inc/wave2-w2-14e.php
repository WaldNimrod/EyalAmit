	...
	?>
		...
		<section class="ea-14e-section" aria-labelledby="ea-mem-a">
			<div class="ea-14e-inner">
				...
				<div class="ea-14e-prose">
					...
					<p>בהקשר של הדיג׳רידו, נכון להיום, וככול הידוע לי, ארבעת בניו של מוקש ועבדכם הנאמן - היחידים בעולם הממשיכים כרגע את דרכו, משנתו ומורשתו. ארבעת בניו בבית המלאכה ברישיקש - עוסקים בעיקר במלאכת בניית הכלים, ואנוכי בסטודיו</p>
					<p>המרכז לטיפול שהקמתי בחצר ביתנו בפרדס חנה - מלמד, בונה, ובעיקר מטפל ומלווה תהליכי ריפוי</p>
				</div>
				<div class="ea-14e-pullquote">
					<blockquote>״ארבעת בניו של מוקש ועבדכם הנאמן - היחידים בעולם הממשיכים כרגע את דרכו, משנתו ומורשתו.״</blockquote>
				</div>
			</div>
		</section>
		...
		<section class="ea-14e-section ea-14e-section--alt" aria-labelledby="ea-mem-l">
			<div class="ea-14e-inner">
				...
				<div class="ea-14e-prose">
					...
					<p>לילדים חלום משל עצמם... תם עידן מוקש. קוטלי עומד ומתפורר..</p>
					<p>המרכז לטיפול בדיג׳רידו שהקמתי בחצר ביתנו בפרדס חנה קיבל את ברכתו של מוקש בעודו בחיים והוכרז כסניף הישראלי הרשמי של jungel vibes</p>
				</div>
			</div>
		</section>
		...
		<section class="ea-14e-section" aria-labelledby="ea-mem-r">
			<div class="ea-14e-inner">
				...
				<div class="ea-14e-prose">
					<p>כמובן שיש עוד מורים, בנאים ומטפלים רבים אחרים בדיג׳רידו, בארץ ובכל רחבי העולם, שיצאו מבית מלאכתו של מוקש, את חלקם אני מכיר באופן אישי, אך לצערי זיקתם למוקש והקשר אליו אבדו מזמן. מורשתו ומשנתו של מוקש כלל איננה באה לידי ביטוי בעשייתם, בהוויתם, או בהוראתם. מוקש נשכח מלבם. ואכן, בודדים ומעטים מאוד האנשים שזכו להכיר את מוקש מקרוב והצליחו לראות ולהכיר באמת גם את האיש שמעבר ל-"בונה הדיג׳ים ההודי מרישיקש".</p>
				...
				<p class="ea-14e-note">פרטים ביוגרפיים על מוקש, תאריכי לידה-פטירה ותמונות לדף ההנצחה — יושלמו ויאומתו בכפוף לאישור אייל ולרגישות התוכן.</p>
			</div>
		</section>
		<?php
}
