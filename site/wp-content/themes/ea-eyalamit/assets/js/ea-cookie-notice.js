 ...
 *
 * Dialog markup is printed at wp_footer:5; this file is printed later with
 * the other footer scripts. DOMContentLoaded still wraps boot so a cached
 * copy that races the markup cannot no-op.
 */
(function () {
	'use strict';
