...
**ביצוע — לפי מפת דרכים 2026 (v12):** מתקדמים לפי אפיון פנימי CANONICAL ואבני דרך M1–M7 ב-[`docs/project/ROADMAP-2026.md`](project/ROADMAP-2026.md); **אין עצירת בנייה** על אישור מוקדם מאייל. **מסירת האתר לאייל** מוגדרת כאבן דרך **M7** (חבילת מסירה + גישה). משוב מאייל אחרי המסירה — לשדרוגים, לא כשער לפני בנייה.
