...
- לאחר קליטה: עדכון [`2026-04-02--INGEST-STATUS.md`](../../from-eyal/2026-04-02--INGEST-STATUS.md) (או קובץ סטטוס חדש בתאריך המסירה).  
...
לוגו ופורמט קבצים — [`LOGO-ASSETS-AND-FORMAT-SPEC.md`](../../from-eyal/LOGO-ASSETS-AND-FORMAT-SPEC.md).  
שאר מדיה: קישורי Drive בשדה `driveRefs` או `media_notes`.

---

*מסמך זה משלים את [`eyal_amit_dev_agent_build_spec.md`](../../from-eyal/eyal_amit_dev_agent_build_spec.md) (טכני־תבניתי) ואת מסמך המפתח GEO/AEO/SEO — לא מחליף אותם.*
