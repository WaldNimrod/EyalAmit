...
- **ארכיון מול אייל:** `docs/project/eyal-ceo-submissions-and-responses/` (`from-eyal`, `to-eyal` כולל גלים ו־`_shared-assets`, `archive`, `EYAL-CORRESPONDENCE-CANON.md`, אינדקס ב-README).
