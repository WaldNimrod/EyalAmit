...
נימרוד מדביק את זה בצ'אט של צוות 10. בלי UUID. מחליפים רק את שורת `קרא`, ואם יש worktree — את שורת `צ'קאאוט`.

```
מאת: 110
אל: 10
קרא: file:///…/TO-TEAM10-….md
צ'קאאוט: file:///Users/nimrod/Documents/AOS_V5/EyalAmit.co.il-2026
```

## איך 110 מנהל בפועל

1. כותב פקודה לתיבה.
2. נותן לנימרוד את בלוק ההדבקה, עם הנתיב המלא בשורת `קרא`.
