...
- **D-FILM = embed the WHOLE film from YouTube.** Nimrod: *"הסרט התיעודי - למה לא כל הסרט אמבד מיוטיוב?"* → embed the **full** documentary ("MUKESH – The Art of Shanti Living") from YouTube at the page bottom, not a promo clip. **YouTube URL is still needed** (ask Eyal — in the WhatsApp draft — or locate it).
...
- **Film (D-FILM):** embed the **full** YouTube film at the bottom (responsive 16:9, lazy, privacy-nocookie). **Blocker:** the YouTube URL — request from Eyal (WhatsApp draft item #1) or locate "MUKESH – The Art of Shanti Living". Until then, leave a clearly-marked placeholder + keep the page launch-valid.
