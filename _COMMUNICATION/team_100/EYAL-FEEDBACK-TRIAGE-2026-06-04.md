...
| 9 | **More pages not built**: stand, floor-stand, repair, tool-sales (+ re-review full doc list) | content/build | The 5 pages **EXIST** (return 200) but with **partial/mockup content** (team_190 F01); sources exist in 25.5.26 — **reconcile verbatim + verify IA/nav**, not build-from-scratch | Reconcile the 5 shop/repair pages from source + IA/nav verify; team_10 |
