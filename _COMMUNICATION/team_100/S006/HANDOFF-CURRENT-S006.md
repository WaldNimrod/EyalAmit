...
**עודכן:** 2026-08-17 (סשן 3) · **שלב פעיל:** 1 (ליבה, דסקטופ בלבד)
...
| R1-02 | `/treatment/` | **הוגש לבדיקה** · שתי גרסאות חיות (מוצע + `?compare=eyal`) · **VERDICT PASS** (`composer-2.5` ≠ בנאי Grok) · T-01 בחירת גרסה + T-02 סרטון ממתינים לאייל |
...
|---|---|---|---|
| 1 | R1-02 | `/treatment/` | `content 13.8.26/טיפול בדיג'רידו/` — בסשן 3; לא לפתוח עמוד אחר עד אישור |
