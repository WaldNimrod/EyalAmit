...
| **15-B** | Content reconciliation — **service/content pages**: `/method`, `/treatment`, `/sound-healing`, `/lessons` + home invented blocks | #4-adjacent, audit | `method.md`, `treatment.md`, `sound_healing_final.md`, `lesons.md`, `homepage1-3 v2.md` | no |
| **15-C** | Content reconciliation — **commerce**: `/muzza` + book-detail ×3 | #4, #5 | `MUZZA.md`, `eyal_tsva_FINAL.md`, `kushi_full.md`, `vekatavta.md` | no |
| **15-D** | **Build 5 unbuilt pages**: tools-for-sale, bags, stands-storage, floor-stand, repair | #9 | `buy didgeridoo.md`, `bags for didg.md`, `stend for hanging.md`, `stend for playing.md`, `build didg.md` | no |
| **15-E** | **FAQ overhaul** — show ALL questions per page (not 3) + full FAQ page section TOC/jump-nav + **testimonials carousel** (more items, L↔R moving) | #1, #2, #3 | `FAQ FINAL.md` + testimonials source (TBD w/ Eyal) | partial (carousel item list) |
| **15-F** | **Eyal-blocked**: About page (`/eyal-amit`), Mokesh source decision, galleries/media real content | #7, #8 | About doc (pending upload), H1 decision, real gallery/testimonial lists | **yes — await Eyal** |
